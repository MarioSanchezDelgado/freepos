...
#ifndef __FPOS_FUNC_H___
#define __FPOS_FUNC_H__
...
short err_invoke(short);


extern char * string_right_justify(char *, short, short, char *);
...
extern void   wait_for_closed_drawer(char *, char *);
extern short  open_and_close_drawer(char *, short);
extern short  vfy_valepavo_save (char *, short);

extern double rnd_curr(double);
extern double floor_price( double );
extern short  ftoa(double, short, char *);
extern double atof_price(char *);
extern short  ftoa_price(double, short, char *);
...
extern void   inp_debug(char *, short, short);
...
extern char *get_compile_date(void);
...
extern int init_invoice_user(char *data, short key);
...
extern short Prev_DoTotal_ST_init(char *data, short key);
...
extern  short prc_PerceptionInput_name(char *data, short key);
extern short Prev_Amnt_Enought_init(char *data, short key);

extern  short prc_Input_name(char *data, short key); //mname

//extern int getNameFromCardHolder( char  * dni, CARDHOLDER_DEF * cardholder);
...
extern  char *cupon_global_inv_TXT[][3];
extern  int     prom_type_CUPON_GLOBAL [];
extern char * cupon_global_xr_TXT[];
