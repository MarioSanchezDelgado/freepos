 ...
 * --------------------------------------------------------------------------
 * 11-Dec-2000 Modified de-init: an extra message argument             R.N.B.
 * --------------------------------------------------------------------------
 * 06-Jun-2001 Added err_init_environment to allow startup without DB  R.N.B.
 * --------------------------------------------------------------------------
 * 05-Dec-2001 Changes for Article Finder.                               M.W.
 * --------------------------------------------------------------------------
 * 09-Apr-2002 Added Customer Fee on Day Pass                            M.W.
 * --------------------------------------------------------------------------
 * 25-Apr-2003 Added ICUR_ERR and INOT_ERR.                              M.W.
 * --------------------------------------------------------------------------
...
#ifndef __WPOS_MN_H__
#define __WPOS_MN_H__
...
extern void  de_init(_TCHAR *);         /* Program Exit point                */

extern _TCHAR last_condition[];         /* used by article finder            */
extern long   art_no_from_finder;       /* art_no returned by art finder     */

extern _TCHAR  sinal[];                 /* calculator                        */
